...
let verifyAccessToken = async function(accessToken) {
    ...
    let cert = fs.readFileSync("/opt/nodejs/node_modules/jwt_"+process.env.ENVIRONMENT+".pub");
    log('certs ----', cert);
...
exports.handler = async function(event, context, callback) {
    console.log("START: EXTEND SESSION API AUTHORIZER");
    ...
    console.log("END: EXTEND SESSION API AUTHORIZER");
    return iamPolicy;
};
